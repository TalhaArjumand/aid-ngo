				...
				<div class="col-lg-12">
					...
					<div class="d-flex mt-2">
						<Checkbox
							...
							@input="
								(value) => (payload.require_evidence = value)
							"
						/>
						<label for="evidence" class="ml-2"
						...
						<div class="col-lg-12">
							<div class="d-flex mt-">
								<Checkbox
									...
									@input="
										(value) =>
											(payload.require_vendor_approval = value)
									"
								/>
								<label
									for="require-vendor-approval"
									class="ml-2 approval"
						...
						<div class="col-lg-12">
							<div class="d-flex mt-">
								<Checkbox
									...
									@input="
										(value) =>
											(payload.require_agent_approval = value)
									"
								/>
								<label
									for="require-agent-approval"
									class="ml-2 approval"
			...
			try {
				...
				if (this.payload.require_evidence) {
					if (
						...
						this.$toast.error(
							'Please select either vendor or agent approval'
						);
						return;
					}
				}
