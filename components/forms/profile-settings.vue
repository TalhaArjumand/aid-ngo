					...
					<form v-if="step === 1" @submit.prevent="updateOrganisationProfile">
						...
						<div class="row sizing-top">
							...
							<div class="col-lg-6 mb-4">
								...
								<input type="text" class="form-controls px-3" :class="{
									error: $v.payload.organisation_profile.state.$error
								}" id="state" placeholder="Texas" v-model="payload.organisation_profile.state"
						...
						<div class="row">
							...
							<div class="col-lg-6 mb-4">
								...
								}" v-model="payload.organisation_profile.address" @blur="$v.payload.organisation_profile.address.$touch()" />
							</div>
...
" />
					...
					<form v-if="step === 2" @submit.prevent="updateUserProfile">
						...
						<div class="row sizing-top">
							...
							<div class="col-lg-6 mb-4">
								...
								<div>
									<el-select id="dropdown" v-model="payload.user_profile.country" filterable placeholder="Country"
						...
						<div class="row">
							...
							<div class="col-lg-6 mb-4">
								...
								<el-select autocomplete="new-password" id="dropdown" v-model="payload.user_profile.currency" filterable
									...
									<el-option v-for="(currencyCode, i) in countries" :key="i" :label="
								...
								<div class="col-lg-6 mb-4">
									...
									<div>
										<el-select id="dropdown" v-model="payload.user_profile.gender" filterable placeholder="Gender"
											class="">
											<el-option v-for="(status, i) in gender" :key="i" :label="status.name" :value="status.name">
											</el-option>
										</el-select>
									</div>
								</div>
								...
								<div class="col-lg-6 mb-4">
									...
									<div>
										<el-select id="dropdown" v-model="payload.user_profile.marital_status" filterable
											...
											<el-option v-for="(type, i) in marital_status" :key="i" :label="type.name" :value="type.name">
											</el-option>
										</el-select>
									</div>
								</div>
						...
						<section v-if="payload.user_profile.country == 'NG'">
							...
							<div class="row">
								...
								<div class="col-lg-6 align-self-center  mb-4 mt-lg-4">
									<button class="pointer verify-btn poppins" @click="verifyIdentity">
										Verify NIN
									</button>
									<!-- 
                     :disabled="
                    ...
                    " -->
							...
							<div class="row" v-if="isIdentityVerified">
								...
								<div class="col-lg-6 mb-4">
									...
									<input type="text" id="first_name" placeholder="Juliana" class="form-controls px-3" :class="{
										error: $v.payload.user_profile.first_name.$error
									}" v-model="payload.user_profile.first_name" @blur="$v.payload.user_profile.first_name.$touch()" disabled />
								</div>
								...
								<div class="col-lg-6 mb-4">
									...
									<input type="text" id="last_name" placeholder="Orji" class="form-controls px-3" :class="{
										error: $v.payload.user_profile.last_name.$error
									}" v-model="payload.user_profile.last_name" @blur="$v.payload.user_profile.last_name.$touch()" disabled />
								</div>
							</div>
						</section>
		...
		<div class="col-lg-3">
			<b-card class="profile-card pb-2">
				...
				<!-- websiteUrl here -->
				<b-card-text class="profile-card-website-url secondary-black text-sm d-flex justify-content-center">
					<a :href="websiteUrl" target="_blank" rel="noreferrer" class="secondary-black font-medium">
						{{ websiteUrl }}</a>
				</b-card-text>
			</b-card>
		</div>
