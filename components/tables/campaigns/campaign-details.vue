<template>
    <div class="campaign-details-holder p-4">
        <Modal id="campaign-prompt" :title="status + ' ' + 'campaign'">
            <campaign-prompt @handleCampaign="handleCampaign" :status="status" :title="details.title" />
        </Modal>
        ...
        <div class="campaign-details-inner mt-4 p-4">
            ...
            <div v-if="details.type == 'cash-for-work'">
                <!-- Progress bar here -->
                <b-progress :value="(details.completed_task / details.task_count) * 100" :max="max" variant="success"
                    class="mb-3 mt-1"></b-progress>
        ...
        <div v-if="statuses.includes(details.status)" class="mt-3">
            <div class="d-flex">
                ...
                " :has-icon="false" :has-border="true"
                    ...
                    @click="
                        handleModal(
                            details.status == 'paused' ? 'resume' : 'Pause'
                        )
                    " />
