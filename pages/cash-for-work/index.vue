<template>
    <div class="main container transparent">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="position-relative">
                            <input type="text" class="form-controls search" placeholder="Search campaigns..."
                                v-model="searchQuery" />
        ...
        <div class="row mt-4 pt-2">
            ...
            <div v-else-if="resultQuery.length" class="col-lg-4 mb-4" v-for="campaign in resultQuery"
                :key="campaign.id">
                <div class="card__holder">
                    <div class="p-4">
                        ...
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <button type="button" :disabled="campaign.is_funded"
                                class="border-0 bg-transparent fund-btn poppins" @click="handleModal(campaign)">
                                Fund campaign
                            </button>
