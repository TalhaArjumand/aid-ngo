<template>
  <div class="main container transparent">
    <!-- Modals here -->
    <Modal id="new-cash" title="new campaign">
    ...
    <Modal id="fund-cash-for-work" title="fund cash for work">
      <fund-cash-for-work :c4w="SelectedC4w" @fundCashForWork="fundCashForWork" />
    </Modal>
    ...
    <div class="row pt-4 mt-2">
        ...
        <div class="row">
          <div class="col-lg-5">
            ...
            <div class="position-relative">
              <input type="text" class="form-controls search" placeholder="Search campaigns..." v-model="searchQuery" />
      ...
      <div class="ml-auto mx-3">
        <Button text="Create new" custom-styles="height:50px" @click="$bvModal.show('new-cash')" />
      </div>
    </div>
    ...
    <div class="row mt-4 pt-2">
      ...
      <div v-else-if="resultQuery.length" class="col-lg-4 mb-4" v-for="campaign in resultQuery" :key="campaign.id">
        <div class="card__holder">
          <div class="p-4">
            ...
            <div class="d-flex">
              <svg class="mt-1" width="26" height="16" viewBox="0 0 26 16" fill="none"
            ...
            <b-progress :value="
                (campaign.completed_task /
                    campaign.task_count) *
                100
            " :max="100" variant="success" class="mb-3 mt-1"></b-progress>
            ...
            <div class="d-flex">
              ...
              <div class="ml-auto">
                <div class="task-badge d-flex align-items-center px-3">
                  {{
                  Number((campaign.completed_task /
                  campaign.task_count) *
                  100).toFixed(0) || 0
            ...
            <div class="d-flex justify-content-between mt-2">
              <Button :has-border="true" :has-icon="false" text="Create task"
                custom-styles="height:41px; font-weight: 600; border-radius: 5px; font-size: 0.875rem"
                @click="handleNewTask(campaign)" />

              <button type="button" :disabled="campaign.is_funded" class="border-0 bg-transparent fund-btn poppins"
                @click="handleModal(campaign)">
                Fund campaign
              </button>

              <button type="button" class="border-0 bg-transparent" @click="
                  $router.push(
                      `/cash-for-work/${campaign.id}`
                  )
              ">
    ...
    async fetchAllCampaigns() {
      try {
        ...
        const response = await this.$axios.get(
          `/organisations/${+this
            .id}/campaigns/all?type=cash-for-work`
        );
